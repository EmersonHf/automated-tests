            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                   <form method="POST" action="{{route('posts.update',$post)}}">
                    ...
                    Title:
                    <br>
                    <input  type="text" value="{{$post->title}}" name="title" class=" block mt-1 w-full font-medium text-sm text-gray-700 dark:text-gray-300">
                    <br><br>
                    Post Text:
                    <textarea  type="text" name="post_text" class=" block mt-1 w-full font-medium text-sm text-gray-700 dark:text-gray-300">{{$post->post_text}}</textarea>
                    <br><br>
                    Category:
                    <br>
